...
const tools = [
  {
    ...
    description:
      "Pretty-print, auto-repair malformed JSON, or crush it to one line. Catches parse errors with exact line and column numbers.",
    accent: "#10b981",
  ...
  },
  {
    ...
    description:
      "Side-by-side or inline diff powered by Monaco. Auto-detects language, shows +/− stats, and ignores whitespace on demand.",
    accent: "#6366f1",
  ...
  },
  {
    ...
    description:
      "Chain case transforms, whitespace ops, find/replace with regex, line sorting, deduplication, and Base64/URL/HTML encoding.",
    accent: "#f59e0b",
  ...
  },
  {
    ...
    description:
      "Paste HTML and see it rendered instantly in a sandboxed browser preview. Supports CSS and JavaScript.",
    accent: "#06b6d4",
  ...
  },
  {
    ...
    tagline: "**bold** *italic* `code`",
    description:
      "Live Markdown preview with GFM support — tables, code blocks, blockquotes, and more. Export to PDF with one click.",
    accent: "#f43f5e",
    glow: "rgba(244,63,94,0.15)",
    border: "rgba(244,63,94,0.18)",
    borderHover: "rgba(244,63,94,0.5)",
    tags: ["GFM", "live preview", "export PDF"],
  },
  {
    id: "jwt",
    path: "/jwt",
    ...
    description:
      "Decode any JWT instantly — inspect header, payload, and signature in three panels. Highlights expiry status relative to now.",
    accent: "#a855f7",
...
const perks = [
  ...
  { Icon: Lock, label: "Private", desc: "Data never leaves your machine" },
  {
    Icon: HardDrive,
    label: "Persistent",
    desc: "Survives refresh via localStorage",
  },
];
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          zIndex: 0,
          background:
            "radial-gradient(ellipse 70% 40% at 50% 0%, rgba(99,102,241,0.14) 0%, transparent 70%)",
        }}
      />
      ...
      >
        ...
        <h1
          ...
          style={{
            ...
            background:
              "linear-gradient(160deg, #ffffff 0%, #ffffff 45%, rgba(255,255,255,0.45) 100%)",
      ...
      >
        <div
          ...
          style={{
            padding: "clamp(0.75rem, 2vh, 1.25rem) clamp(1.5rem, 4vw, 4rem)",
            maxWidth: "1100px",
          }}
        >
